...
import useMapState from "../../hooks/useMapState";
  ...
  const MlShareMapState = (props) => {
    ...
    useEffect(() => {
      ...
      console.log(layerStatesRestored.current);
      console.log(mapState.layers);

      if (initialUrlParams.layers) {
        initialUrlParams.layers.forEach((layer) => {
          console.log(layer);
          console.log(mapRef.current?.getLayer(layer.id));
          console.log(layerStatesRestored.current[layer.id]);
          if (
